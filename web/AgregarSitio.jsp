...
function AgregarSitio() {
	...
	if (confirm("Esta seguro de agregar el Sitio " + nombre + "?")) {
...
<div>
	...
	<table>
		...
		<tr>
			<td>Nombre</td>
			<td colspan="3"><input type="text" name="nombre" id="nombre" size=40></td>
		</tr>
		<tr>
			<td>Descripcion</td>
			<td colspan="3"><textarea rows="3" cols="40" name="descripcion" id="descripcion"></textarea></td>
		</tr>
		<tr>
			<td>Latitud</td>
			<td><input type="text" id="latitud" name="latitud" value="0"></td>
			<td>Longitud</td>
			<td><input type="text" id="longitud" name="longitud" value="0"></td>
		</tr>
	</table>
	<input type="button" class="boton" id="cmd_update" value="Agregar" onclick="javascript:AgregarSitio()" class="boton" >
	</form>
</div>
