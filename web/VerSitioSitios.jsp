...
<%
	String sitio = (String)request.getParameter("sitio");
	String latitud = "0";
	String longitud = "0";
	String descripcion = "";
	String nombre = "";
	...
	String sql = "select latitud,longitud,descripcion from sitios where sitio=?";
	PreparedStatement pst = conexion.getConnection().prepareStatement(sql);
	pst.setString(1, sitio);
...
<title>Ubicacion Sitio <%= nombre %></title>
...
function initialize() {
	...
	var contenido ="<B>Informacion Posición</b><br/>Descripcion: <b><%=  descripcion %></b><br/>Coordenadas: <b><%= latitud %>,<%= longitud %></b>" ;
