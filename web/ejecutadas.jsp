...
<%
	...
	String sql = "SELECT QO_ORDENES.*, RECURSO.RECUNOMB "
			...
			+ " WHERE QO_ORDENES.ESTADO_OPER IN (3,99) " 
...
<title>EJECUTADAS LOTE <%= (String)request.getParameter("num_lote") %></title>
...
<h2>EJECUTADAS LOTE <%= (String)request.getParameter("num_lote") %></h2>
