...
<%    if ((String) request.getParameter("id") == null) {
    ...
    if (!ma.Find(Integer.parseInt(id))) {
        conexion.Close();
        response.sendRedirect("misarchovos.jsp?operacion=plantilla");
        return;
    }
    ...
    <head>
        ...
        <script type="text/javascript">
            function procesarArchivo(file)
            {
                ...
                $("#respuesta").html("<img src='images/loading.gif'> Procesando Archivo...");
                var url = "SrvProcesarPlantilla";
                $("#respuesta").load(url, {
                    separador: separador,
                    file: file
                });
        ...
        <title>PROCESAR ARCHIVO DE PLANTILLA</title>
    </head>
    <body>
        <%@ include file="header.jsp"%>
        <div class="contencenter demo">
            <h2>PROCESAR ARCHIVO DE PLANTILLA</h2>
            <form name="form1" action="SrvProcesarPlantilla" method = "POST">
                <table>
                    <tr>
                ...
                <input type="button" name="procesar" value="Procesar Archivo" onclick="javascript:procesarArchivo('<%= archivo.getFilename()%>')">
            </form>
            <div id="respuesta">
