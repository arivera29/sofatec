...
<title>Consulta Visitas Fallidas</title>
...
$(function() {
	...
	function consultar() {
		...
		var url = "ListadoVisitaFallida.jsp?fecha_inicial=" + fecha_inicial + "&fecha_final=" + fecha_final;
		$("#list").load(url);
...
<h2>Listado Visitas Fallidas</h2>
<div id="info"></div>
<form action="SrvDownloadOrders" name="form1">
	<table>
		<tr>
			<th colspan="4">Criterio de Fecha</th>
		</tr>
		<tr>
			<td>Fecha Inicial</td>
