...
$(function() {
	...
	function consultar() {
		...
		var url = "ListadoEjecucionLote.jsp";
...
<div id="info"></div>
<form action="DescargarListadoEjecucionLote.jsp" name="form1">
	<table>
		<tr>
		...
		<tr>
			<td colspan="4"><input type="button" name="cmd_buscar" value="Consultar" onclick="javascript:consultar()" > <input type="submit" name="cmd_descargar" value="Descargar Excel"></td>
		</tr>
	</table>
