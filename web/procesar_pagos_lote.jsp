...
<title>PROCESAR ARCHIVO DE PAGOS</title>
</head>
<body>
<%@ include file="header.jsp"%>
<div class="contencenter demo">
<h2>PROCESAR ARCHIVO DE PAGOS</h2>
<form name="form1" action="ProcesarPagosLote" method = "POST" onsubmit="javascript:return validar();">
<table>
<tr>
