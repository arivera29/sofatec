...
<title>PROCESAR ARCHIVO DE ASIGNACION</title>
</head>
<body>
<%@ include file="header.jsp"%>
<div class="contencenter demo">
<h2>PROCESAR ARCHIVO DE ASIGNACION</h2>
<form name="form1" action="ProcessAssignOrders" method = "POST" onsubmit="javascript:return validar();">
<table>
<tr>
