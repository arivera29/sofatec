...
<%
	...
	ArrayList<GeoOrden> lista = gps.UbicacionOrdenesPendientes();
	int contador =0;
%>
...
<body onload="javascript:inicializar()">
  <h2>ORDENES PENDIENTES DE ASIGNAR</h2>
  Total Ordenes pendientes de asignar: <%= lista.size() %><br/>
