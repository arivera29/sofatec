 ...
 */
@WebServlet("/XmlOrdersRuta")
public class XmlOrdersRuta extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public XmlOrdersRuta() {
        super();
    ...
    protected void ProcesarPeticion(HttpServletRequest request,
        ...
        calendar2.set(calendar1.get(Calendar.YEAR), calendar1.get(Calendar.MONTH), calendar1.get(Calendar.DATE), 9, 30);
        ...
        if (calendar1.compareTo(calendar2) > 0) {
        		out.println("<ordenes>");
       		 	...
       		 	out.println("</item>");
       		 	out.println("</ordenes>");
        		return;  // sobrepasa la hora estipulada para confirmacion de ruta
