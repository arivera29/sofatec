 ...
 */
@WebServlet("/SrvProcesarRuta")
public class SrvProcesarRuta extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SrvProcesarRuta() {
		super();
	...
	protected void ProcesarPeticion(HttpServletRequest request,
		...
		try {
		 ...
		 out.println("DIRECCION" + reader.getDelimiter() + "LATITUD" + reader.getDelimiter()  + "LONGITUD" + reader.getDelimiter() + "AOL" + reader.getDelimiter() + "RUTA" + reader.getDelimiter() + "ITINERARIO");  // fin de encabezados
