 ...
 * @author aimerrivera
 */
@WebServlet(name = "RESTSuministro", urlPatterns = {"/os/informacion"})
public class RESTSuministro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                controlador.Find();
                SuministroResult suministroResult = controlador.getSuministroResult();
                
                out.print(gson.toJson(suministroResult));
